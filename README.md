...
A Domain controller (DC) refers to a server that runs the AD DS roles and serves as the backbone of your network's identity and access management system.
